...
describe("Страница редактирования профиля", () => {
  ...
  it("Поле имени", async function () {
    await this.browser.assertView(
      ...
      editProfilePage.selectors.nameInput,
      {
        disableAnimation: true,
        screenshotDelay: 300,
      }
  ...
  it("Кнопка сохранения", async function () {
    await this.browser.assertView(
      "edit-profile/save-button",
      editProfilePage.selectors.saveButton,
      {
        disableAnimation: true,
        screenshotDelay: 300,
      }
  ...
  it("Кнопка отмены", async function () {
    await this.browser.assertView(
      "edit-profile/cancel-button",
      editProfilePage.selectors.cancelButton,
      {
        disableAnimation: true,
        screenshotDelay: 300,
      }

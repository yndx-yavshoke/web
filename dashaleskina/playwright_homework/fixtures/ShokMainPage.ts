...
export class ShokMainPage {
  ...
  public successTextMessage: Locator;
  public successGIF: Locator;
  public failedTextMessage: Locator;
  ...
  constructor(public readonly page: Page) {
    ...
    this.successTextMessage = this.page.getByText("Ты уже в ШОКе", {
      exact: true,
    });
    this.successGIF = this.page.getByRole("img");
    this.failedTextMessage = this.page.getByText("Ты еще не в ШОКе", {
      exact: true,
    });
  }
